...
export default function ProdukLayanan() {
  return (
    <section className="w-full px-4 sm:px-8 py-16 sm:py-28 bg-white flex flex-col justify-center items-center gap-6 sm:gap-10 overflow-x-hidden">
        ...
        {[ 
          ...
          >
            ...
            <div className="p-6 flex flex-col items-center gap-4">
              ...
              <p className="text-base sm:text-lg font-normal font-[Montserrat] text-black text-center leading-relaxed">
                {item.desc}
              </p>
            </div>
          </div>
